...
const KNOWN_ALIAS_PAIRS: Array<[namespace: string, id: string]> = [
  ...
  ['fsk', 'real-weatherStation-5'],
  ['fsk', 'virtual-weatherStation-5'],
  ['fsk', 'real-weatherStation-10'],
  ['fsk', 'virtual-weatherStation-10'],
  ['fsk', 'real-weatherStation-15'],
  ['fsk', 'virtual-weatherStation-15'],
  ['fsk', 'real-weatherStation-20'],
  ['fsk', 'virtual-weatherStation-20'],
  ['fsk', 'real-weatherStation-25'],
  ['fsk', 'virtual-weatherStation-25'],
  ['fsk', 'real-weatherStation-30'],
  ['fsk', 'virtual-weatherStation-30'],
  ['fsk', 'real-weatherStation-35'],
  ['fsk', 'virtual-weatherStation-35'],
  ['fsk', 'real-weatherStation-40'],
  ['fsk', 'virtual-weatherStation-40'],
  ['fsk', 'real-weatherStation-45'],
  ['fsk', 'virtual-weatherStation-45'],
  ['fsk', 'real-weatherStation-50'],
  ['fsk', 'virtual-weatherStation-50'],
  ['fsk', 'real-weatherStation-55'],
  ['fsk', 'virtual-weatherStation-55'],
  ['fsk', 'real-weatherStation-60'],
  ['fsk', 'virtual-weatherStation-60'],
  ['fsk', 'real-weatherStation-65'],
  ['fsk', 'virtual-weatherStation-65'],
  ['fsk', 'real-weatherStation-70'],
  ['fsk', 'virtual-weatherStation-70'],
  ['fsk', 'real-weatherStation-75'],
  ['fsk', 'virtual-weatherStation-75'],
  ['fsk', 'real-aton'],
  ['fsk', 'virtual-aton'],
  ['fsk', 'route-start'],
  ['fsk', 'route-waypoint'],
  ['fsk', 'route-end'],
  ['fsk', 'windIndicator-arrow'],
  ['fsk', 'oceanCurrentIndicator-arrow'],
  ['fsk', 'tidalCurrentIndicator-arrow'],
  ['binnacle', 'anchorage'],
  ['binnacle', 'boatramp'],
  ['binnacle', 'bridge'],
  ['binnacle', 'business'],
